(function (window, document, $) {
  ...
  $(document).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
    ...
    // Toggle menu
    $.app.menu.toggle();
    var menu_collapse_data;
    if ($.app.menu.expanded) {
      menu_collapse_data = '0';
    } else {
      menu_collapse_data = '1';
    }

    $.post("/api/user/menu",
    {
      menu_collapse: menu_collapse_data
    },
  ...
  var dataLayout = $body.attr('data-layout') ? $body.attr('data-layout') : 'light-layout';
  ...
  function setLayout(currentLocalStorageLayout) {
    ...
    $body.removeClass('semi-dark-layout dark-layout bordered-layout');
    brandLogo.removeClass('dark-layout-logo');
    brandText.removeClass('dark-layout-logo');

    if (switchToLayout === 'dark-layout') {
      $body.addClass('dark-layout');
      brandLogo.addClass('dark-layout-logo');
      brandText.addClass('dark-layout-logo');
      ...
      $body.attr('data-layout', 'bordered-layout')
      mainMenu.removeClass('menu-dark').addClass('menu-light');
      navbar.removeClass('navbar-dark').addClass('navbar-light');
      layout = 'bordered-layout';
      ...
      $body.attr('data-layout', 'light-layout')
      mainMenu.removeClass('menu-dark').addClass('menu-light');
      navbar.removeClass('navbar-dark').addClass('navbar-light');
      layout = 'light-layout';
      // navLinkStyle.find('.ficon').replaceWith(feather.icons['moon'].toSvg({ class: 'ficon' }));
